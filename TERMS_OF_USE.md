...
### Free Content
Module 1 (Swift Fundamentals) is permanently free and does not require purchase.

### Paid Content
Additional learning content is available as one-time, non-consumable in-app purchases (all prices in USD or local equivalent):
- **Individual modules** at $2.99 each
- **Season bundles** (all modules of a content season) — e.g. Season 1: First Steps at $15.99
- **Lifetime Everything** at $69.99 — unlocks all current content and all future additions

Payment is processed by Apple's StoreKit 2 and is subject to Apple's terms.

### Restore Purchases
Purchases can be restored on any device signed into the same Apple ID. Use the "Restore Purchases" button in Settings.

### Refunds
All purchases are handled by Apple. Refund requests should be directed to Apple Support at https://reportaproblem.apple.com.
...
- Not interfere with the App's operation or circumvent any security measures

## 6. Account and Data

### Guest Mode
The App works fully in guest mode without an account. All progress is stored locally on your device.

### Sign in with Apple
If you choose to sign in with Apple, your progress can be synced across devices via iCloud. You may sign out at any time.

### Data Loss
We are not responsible for data loss resulting from uninstalling the App, clearing app data, or disabling iCloud sync. We recommend enabling iCloud sync to preserve your progress.
...
- The quality of any content obtained through the App will meet your expectations
...
We reserve the right to modify these Terms at any time. Changes will be posted within the App. Your continued use of the App after changes constitutes acceptance of the new Terms.

## 11. Governing Law

These Terms shall be governed by and construed in accordance with the laws of the European Union and Greece, without regard to its conflict of law provisions.
